...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-basic-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-basic-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-basic')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.1 MB | 752 kB | 244.8 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-cartesian-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-cartesian-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-cartesian')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.4 MB | 863 kB | 279.4 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-geo-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-geo-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-geo')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.1 MB | 775.7 kB | 253.9 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl3d-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl3d-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl3d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 3 MB | 1.2 MB | 382.9 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-gl2d-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-gl2d-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-gl2d')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 3.1 MB | 1.3 MB | 411.9 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-mapbox-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-mapbox-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-mapbox')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 3.4 MB | 1.3 MB | 397 kB |
...
| CDN URL (tagged) | https://cdn.plot.ly/plotly-finance-1.37.1.js |
| CDN URL (tagged minified) | https://cdn.plot.ly/plotly-finance-1.37.1.min.js |
| CommonJS | `require('plotly.js/lib/index-finance')` |

| Raw size | Minified size | Minified + gzip size |
|------|-----------------|------------------------|
| 2.2 MB | 782.1 kB | 253.8 kB |
